...
#define clog(group_id, file_id, ...) \
    logfunc(group_id, file_id, DEF_LOG_LEVEL, showtime, 0, 0, 0, __VA_ARGS__)
#define log(group_id, file_id, ...) \
    logfunc(group_id, file_id, DEF_LOG_LEVEL, showtime, 1, 0, 0, __VA_ARGS__)
#define sclog(...) \
    logfunc(0, 0, DEF_LOG_LEVEL, 0, 0, 0, 0, __VA_ARGS__)
#define slog(...) \
    logfunc(0, 0, DEF_LOG_LEVEL, 0, 1, 0, 0, __VA_ARGS__)
